  ...
  return (
    <>
      <div className="bg-white h-[72px] shadow-[0px_4px_12px_0px_rgba(0,0,0,0.04)] fixed top-0 left-0 right-0 z-50">
        <div className="max-w-[1920px] mx-auto px-4 md:px-8 lg:px-[312px] h-full flex items-center justify-between">
          <button 
            onClick={() => navigate('/')}
          ...
          {/* Desktop Navigation */}
          <nav className="hidden lg:flex items-center gap-[68px] font-medium text-[16px] text-gray-900">
          ...
          <button 
            ...
            className="lg:hidden w-[44px] h-[44px] flex flex-col justify-center items-center gap-[6px] relative"
      ...
      <div className={`lg:hidden fixed top-[72px] left-0 right-0 bg-white rounded-bl-[12px] rounded-br-[12px] shadow-2xl z-50 transition-all duration-300 ease-in-out ${menuOpen ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4 pointer-events-none'}`}>
