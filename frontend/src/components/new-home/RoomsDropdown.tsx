...
const RoomsDropdown: React.FC<RoomsDropdownProps> = ({ value, onChange }) => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div 
          className="fixed left-0 right-0 lg:top-1/2 lg:left-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2 lg:right-auto bg-white w-full lg:w-[180px] rounded-t-[24px] lg:rounded-[12px] shadow-[0px_-4px_12px_0px_rgba(0,0,0,0.08)] lg:shadow-[0px_4px_12px_0px_rgba(0,0,0,0.04)] z-50 py-[12px] max-h-[80vh] overflow-y-auto transition-all duration-300 ease-out"
          style={{ 
            bottom: '0',
