...
async def startup_event():
    ...
    try:
        ...
        # 2. Инициализация базы данных (на случай если миграций нет)
        from src.db.database import init_database
        logger.info("🗄️ Проверка инициализации базы данных...")
        ...
        # Не прерываем запуск приложения, пусть работает без БД для отладки
