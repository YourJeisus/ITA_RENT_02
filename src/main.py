...
async def startup_event():
    ...
    try:
        # ВРЕМЕННО: Принудительное пересоздание таблиц для обновления схемы
        logger.info("🔄 ПРИНУДИТЕЛЬНОЕ пересоздание таблиц для обновления схемы...")
        ...
        logger.error(f"❌ Критическая ошибка startup: {e}")
